...
describe('Profile Controllers', () => {
  ...
  describe('requestPasswordReset', () => {
    it('should request a password reset', async () => {
      (requestPasswordResetService as jest.Mock)
      ...
      .toBe('Password reset code sent to email');
      expect(requestPasswordResetService)
  ...
  describe('resetPassword', () => {
    it('should reset the password', async () => {
      (resetPasswordService as jest.Mock)
      .mockResolvedValue(undefined);
      ...
      expect(resetPasswordService)
      .toHaveBeenCalledWith('test@example.com', '123456', 'newPassword');
    });
  ...
  describe('getProfile', () => {
    it('should get the profile by user ID', async () => {
      ...
      (getProfileByUserId as jest.Mock)
    ...
    it('should return 400 if there is an error', async () => {
      (getProfileByUserId as jest.Mock)
      .mockRejectedValue(new Error('Get profile error'));
  ...
  describe('editProfile', () => {
    it('should update the profile', async () => {
      ...
      .toHaveBeenCalledWith('user-1', { firstName: 'John', lastName: 'Doe' }, 'test@example.com');
    });
  ...
  describe('changePassword', () => {
    it('should update the password', async () => {
      ...
      .toHaveBeenCalledWith('user-1', 'newPassword');
    });

    it('should return 400 if there is an error', async () => {
      (updatePassword as jest.Mock)
      .mockRejectedValue(new Error('Password update error'));
